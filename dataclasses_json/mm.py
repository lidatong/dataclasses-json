...
from dataclasses_json.core import _is_supported_generic, _decode_dataclass, _ExtendedEncoder, _user_overrides_or_exts
...
if sys.version_info >= (3, 7):
    ...
    class SchemaF(Schema, typing.Generic[A]):
        ...
        def load(
            self, data: typing.List[TEncoded], many: bool = True, partial: bool = None, unknown: str = None
        ) -> typing.List[A]:
        ...
        def load(
            self, data: TOneOrMultiEncoded, many: bool = None, partial: bool = None, unknown: str = None
        ) -> TOneOrMulti:
            pass
        ...
        @typing.overload
        def loads(
            self, json_data: JsonData, many: None = None, partial: bool = None, unknown: str = None, **kwargs
        ) -> A:
            pass

        def loads(
            self, json_data: JsonData, many: bool = None, partial: bool = None, unknown: str = None, **kwargs
        ) -> TOneOrMulti:
            pass
...
def build_schema(cls: typing.Type[A], mixin, infer_missing, partial) -> typing.Type[SchemaType]:
    ...
    DataClassSchema: typing.Type[SchemaType] = type(
        ...
        (Schema,),
        {"Meta": Meta, f"make_{cls.__name__.lower()}": make_instance, "dumps": dumps, "dump": dump, **schema_},
    )
