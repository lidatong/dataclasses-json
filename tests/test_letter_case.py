...
class CamelCasePerson:
    given_name: str = field(metadata={"dataclasses_json": {"letter_case": LetterCase.CAMEL}})


@dataclass_json
@dataclass
class KebabCasePerson:
    given_name: str = field(metadata={"dataclasses_json": {"letter_case": LetterCase.KEBAB}})


@dataclass_json
@dataclass
class SnakeCasePerson:
    given_name: str = field(metadata={"dataclasses_json": {"letter_case": LetterCase.SNAKE}})


@dataclass_json
@dataclass
class PascalCasePerson:
    given_name: str = field(metadata={"dataclasses_json": {"letter_case": LetterCase.PASCAL}})
