...
class TestCatchAllUndefinedParameters:
    ...
    def test_undefined_parameters_catch_all_invalid_back(self,
                                                         invalid_response):
        dump = UnknownAPIDump.from_dict(invalid_response)
        inverse_dict = dump.to_dict()
        assert inverse_dict == invalid_response

    def test_undefined_parameters_catch_all_valid(self, valid_response):
        dump = UnknownAPIDump.from_dict(valid_response)
        assert dump.catch_all == {}

    def test_undefined_parameters_catch_all_no_field(self, invalid_response):
        with pytest.raises(UndefinedParameterError):
            UnknownAPIDumpNoCatchAllField.from_dict(invalid_response)

    def test_undefined_parameters_catch_all_multiple_fields(self,
                                                            invalid_response):
        @dataclass_json(undefined=Undefined.INCLUDE)
        @dataclass()
    ...
    def test_undefined_parameters_catch_all_works_with_letter_case(self,
    ...
    def test_undefined_parameters_catch_all_raises_if_initialized_with_catch_all_field_name(
            self,
            valid_response):
    ...
    def test_undefined_parameters_catch_all_initialized_with_dict_and_more_unknown(
            self,
            invalid_response):
    ...
    def test_undefined_parameters_raises_with_default_argument_and_supplied_catch_all_name(
            self,
            invalid_response):
    ...
    def test_undefined_parameters_doesnt_raise_with_default(self,
                                                            valid_response,
                                                            invalid_response):
        @dataclass_json(undefined="include")
        @dataclass()
    ...
    def test_undefined_parameters_doesnt_raise_with_default_factory(self,
                                                                    valid_response,
                                                                    invalid_response):
        @dataclass_json(undefined="include")
        @dataclass()
    ...
    def test_undefined_parameters_catch_all_nested_schema(self, boss_json):
        @dataclass_json(undefined=Undefined.INCLUDE)
    ...
    def test_undefined_parameters_catch_all_schema_dump(self, boss_json):
        import json
    ...
    def test_undefined_parameters_catch_all_schema_roundtrip(self, boss_json):
        @dataclass_json(undefined=Undefined.INCLUDE)
        @dataclass(frozen=True)
        class Minion:
            name: str
    ...
    def test_undefined_parameters_catch_all_init_valid(self, valid_response):
        dump = UnknownAPIDump(**valid_response)
        assert dump.catch_all == {}

    def test_undefined_parameters_catch_all_init_invalid(self,
                                                         invalid_response):
        dump = UnknownAPIDump(**invalid_response)
        assert {"undefined_field_name": [1, 2, 3]} == dump.catch_all

    def test_undefined_parameters_catch_all_init_args(self):
    ...
    def test_undefined_parameters_catch_all_init_args_kwargs_mixed(self):
        dump = UnknownAPIDump("some-endpoint", {"some-data": "foo"}, "unknown1",
    ...
    def test_undefined_parameters_catch_all_default_no_undefined(self,
                                                                 valid_response):
        @dataclass_json(undefined="include")
        @dataclass()
        class UnknownAPIDumpDefault:
    ...
    def test_undefined_parameters_catch_all_default_factory_init_converts_factory(
            self,
            valid_response):
        @dataclass_json(undefined="include")
        @dataclass()
...
class TestRaiseUndefinedParameters:
    ...
    def test_undefined_parameters_raise_invalid(self, invalid_response):
        with pytest.raises(UndefinedParameterError):
            WellKnownAPIDump.from_dict(invalid_response)

    def test_undefined_parameters_raise_valid(self, valid_response):
        assert valid_response == WellKnownAPIDump.from_dict(
            valid_response).to_dict()

    def test_undefined_parameters_raise_nested_schema(self, boss_json):
        @dataclass_json(undefined=Undefined.RAISE)
        @dataclass(frozen=True)
        class Minion:
            name: str
    ...
    def test_undefined_parameters_raise_init(self, invalid_response):
...
class TestIgnoreUndefinedParameters:
    ...
    def test_undefined_parameters_ignore_to_dict(self, invalid_response,
                                                 valid_response):
        dump = DontCareAPIDump.from_dict(invalid_response)
        dump_dict = dump.to_dict()
        assert valid_response == dump_dict

    def test_undefined_parameters_ignore_nested_schema(self, boss_json):
        @dataclass_json(undefined=Undefined.EXCLUDE)
        @dataclass(frozen=True)
        class Minion:
            name: str
    ...
    def test_undefined_parameters_ignore_init_args(self):
    ...
    def test_undefined_parameters_ignore_init_invalid(self, invalid_response,
                                                      valid_response):
...
class TestMiscellaneousUndefinedParameters:
    ...
    def test_undefined_parameters_catch_all_ignore_mix_nested_schema(self,
                                                                     boss_json):
        @dataclass_json(undefined=Undefined.EXCLUDE)
        @dataclass(frozen=True)
        class Minion:
    ...
    def test_string_only_accepts_valid_actions(self):
        with pytest.raises(UndefinedParameterError):
